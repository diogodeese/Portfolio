export const projects = [
  {
    ...
    title: "Floppy",
    description:
      "Floppy is a drive website where you can upload files in order to save space your computer. You can share them with your friends and download them later.",
